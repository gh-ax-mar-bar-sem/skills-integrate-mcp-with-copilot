...
# Helper function to check if request is from authenticated teacher
...
def login(username: str, password: str):
    ...
    if verify_teacher(username, password):
        # Return a simple token (username:password)
        return {"success": True, "token": f"{username}:{password}", "message": "Login successful"}
    else:
